...
export const ROOT_DASHBOARD_ROUTE = "/dashboard";
...
export const RESEARCH_ROUTE = `${ROOT_DASHBOARD_ROUTE}/research`;

export const EDIT_STATION_ROUTE = `${ROOT_DASHBOARD_ROUTE}/editing-station`;
